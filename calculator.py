...
canvas = tk.Canvas(bg='#7c798f', bd=0, highlightthickness=0)
...
tk.Label(canvas, text='เครื่องคิดเลข', anchor='e', bg='#272533', fg='white', font=('Franklin Gothic Book', 14, 'bold')).grid(row=0, columnspan=4, sticky='ew', padx=4, pady=2)
...
rtn_btn = tk.Button(canvas, text='=', bg='#d1023d', width=15, height=2, font=('Franklin Gothic Book', 24), command=lambda: event_click("="))
rtn_btn.focus()
